          ...
          <nav class="switch">
            <div class="main tabs">
              <div class="ui stackable grid three column row">
                <div class="column">
                  <a class="nav-item is-active" data-what="currency">⚜ Currency</a>
                </div>
                <div class="column">
                  <a class="nav-item" data-what="experience"><icon data-what="experience" name="award"></icon> Experience</a>
                </div>
                <div class="column">
                  <a class="nav-item" data-what="cookies">
                    <svg class="cookie" data-what="cookies" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" height="15px">
                      <g>
